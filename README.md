...
<div align="center">
  <h3 align="center">Kan-ductor</h3>
  <p>A calm operational board for human and AI coordination.</p>
</div>

Kan-ductor is Piotr + Iskra's fork of upstream Kan. The goal is not to become
another generic PM tool, but to provide a narrow, auditable board where a human
and LLM agents can coordinate operational work.
...
Kan-ductor is licensed under the [AGPLv3 license](LICENSE).
